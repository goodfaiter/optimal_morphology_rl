"""Legacy contact helper used by the old hand-object environments."""
...
class Contacts:
    ...
    def __init__(
        ...
        self.contact_env_lookup = torch.full(
            (len(self.env.num_envs), max_envs_in_set),
            -1,
            dtype=torch.long,
            device=self.device,
        )
    ...
    def update(self) -> None:
        ...
        max_contacts = self.max_contact_pairs_per_env * self.total_num_envs
